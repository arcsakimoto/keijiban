/* お知らせ詳細ページ - 個別投稿の全文表示と編集・削除操作（画像＋PDF添付表示対応） */
        ...
        {attachmentsWithUrls.length > 0 && (
          <div className="mt-6 border-t border-gray-100 pt-6 dark:border-slate-700">
            <h2 className="mb-3 flex items-center gap-2 text-sm font-semibold text-gray-700 dark:text-slate-300">
              ...
              添付ファイル（{attachmentsWithUrls.length}）
            </h2>
            <div className="space-y-2">
              {attachmentsWithUrls.map((att) => (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 transition-colors hover:border-blue-200 hover:bg-blue-50 dark:border-slate-700 dark:bg-slate-700/50 dark:hover:bg-slate-600/50"
                >
                  <svg className="h-8 w-8 shrink-0 text-red-500" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
